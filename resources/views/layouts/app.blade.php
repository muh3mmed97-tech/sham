...
<head>
    ...
    <style>
        ...
        body { display: flex; flex-direction: column; background-color: #f4f7f6; background-image: url('https://www.transparenttextures.com/patterns/arabesque.png'); background-repeat: repeat; }
...
<body>
    ...
    <div class="top-bar"><a href="#">المساعدة</a> | <a href="#">البيع على منصة شام</a></div>
    ...
    @if(session('success'))
        <div style="background: #d4edda; color: #155724; padding: 15px; margin: 10px auto; max-width: 1100px; border-radius: 8px; text-align: center;">
            {{ session('success') }}
        </div>
    @endif
